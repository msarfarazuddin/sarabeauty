...
import { pageSeo, servicesFaqLinks, chooseMassage, chooseMassageLinks } from "@/data/page-seo";
import { ContextualLinks } from "@/components/contextual-links";

const faqs = pageSeo["/services"].faqs;
    ...
    <section className="relative isolate overflow-hidden bg-white py-20 sm:py-24 lg:py-28">
      ...
      <div className="relative mx-auto w-full max-w-[1120px] px-5 sm:px-6 lg:px-8">
        <div className="mx-auto mb-12 max-w-[760px] text-center sm:mb-14">
          ...
          <p className="mx-auto mt-6 max-w-[1000px] text-[15px] leading-[1.7] text-[#575757] sm:text-[16px]">
            <ContextualLinks text={chooseMassage} links={chooseMassageLinks} />
          </p>
        </div>

         <h3
            className="text-[2.5rem] text-center mb-10 leading-[1.05] text-[#395E4C] sm:text-[3.2rem] lg:text-[2.7rem]"
            style={{ fontFamily: "var(--font-display), serif" }}
          >
                    ...
                    <div className="px-5 pb-6 sm:px-7 sm:pb-7">
                      <div className="border-t border-[#395E4C]/10 pt-5 sm:ml-[41px]">
                        <p className="max-w-[800px] text-[14px] leading-[1.75] text-[#626262] sm:text-[15px]">
                          <ContextualLinks text={faq.answer} links={servicesFaqLinks[index] ?? []} />
                        </p>
                      </div>
                    </div>
                  </div>
